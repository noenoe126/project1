        ...
        ***********************************-->
        <div class="nav-header">
            <div class="brand-logo">
                <a href="index.html">
                    <b class="logo-abbr"><img width="100%" src="{{ asset('images/ousc-logo.png') }}" alt=""> </b>
                    <span class="logo-compact"><img width="100%" src="{{ asset('./images/ousc-logo.png') }}" alt=""></span>
                    <span class="brand-title">
                        <img width="100%" src="images/ousc-logo.png" alt="">
                    </span>
                </a>
            </div>
        </div>
                                    ...
                                    <ul>
                                        ...
                                        <hr class="my-2">
                                         <li>
                                          ...
                                          <li><a href="{{ route('logout.perform') }}"><i class="icon-key"></i> <span>Logout</span></a></li>
        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    <li class="nav-label"><a href="{{ route('home.index') }}">Dashboard</a></li>
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{ route('cars.create') }}">Cars Create</a></li>
